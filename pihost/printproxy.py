...
tmpfile = '/tmp/spool.txt'
baudrate = 9600 # change for your serial port
timeout = 2 # timeout in secs to guess/assume end of print, change as needed
